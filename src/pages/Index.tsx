    ...
    <div className="relative min-h-screen w-full overflow-x-hidden">
      ...
      <section id="services" className="min-h-screen bg-white py-20 px-4">
        <div className="container mx-auto">
          ...
          <p className="text-lg max-w-3xl mx-auto text-center mb-12">
            Detailed information about our services will be displayed here. We provide comprehensive solutions tailored to your needs.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Service Cards */}
            {["Strategy", "Design", "Development", "Marketing", "Analytics", "Support"].map((service, index) => (
        ...
        <div className="container mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg mb-6">
              Learn more about our company, mission, and values. We are a team of passionate professionals dedicated to delivering exceptional results.
            </p>
            <p className="text-lg mb-6">
              Founded in 2018, we've grown from a small team of three to over fifty talented individuals. Our focus has always been on quality, innovation, and customer satisfaction.
            </p>
            <div className="bg-white p-6 rounded-lg shadow-md mt-12">
              <h3 className="text-2xl font-semibold mb-4 text-center">Our Mission</h3>
              <p className="text-center text-gray-700">To empower businesses through cutting-edge technology solutions and creative strategies that drive growth and success.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="work" className="min-h-screen bg-white py-20 px-4">
        <div className="container mx-auto">
          ...
          <p className="text-lg max-w-3xl mx-auto text-center mb-12">
            Showcase of our previous projects and case studies. We pride ourselves on delivering exceptional results for our clients.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Project Cards */}
            {Array(6).fill(0).map((_, index) => (
              <div key={index} className="overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-shadow">
                ...
                <div className="p-6 bg-white">
                  ...
                  <p className="text-gray-600 mb-4">A brief description of the project and our involvement.</p>
                  <button className="text-[#9b87f5] hover:text-[#D6BCFA] font-medium">View Case Study</button>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="people" className="min-h-screen bg-gray-100 py-20 px-4">
        <div className="container mx-auto">
          ...
          <p className="text-lg max-w-3xl mx-auto text-center mb-12">
            Meet our team of professionals and learn about their expertise. Each member brings unique skills and perspectives to our company.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {Array(8).fill(0).map((_, index) => (
              <div key={index} className="bg-white rounded-lg overflow-hidden shadow-md text-center">
                <div className="bg-gray-200 h-48 flex items-center justify-center">
                  <span className="text-gray-500">Team Member {index + 1}</span>
                </div>
                <div className="p-4">
      ...
      <section id="blog" className="min-h-screen bg-white py-20 px-4">
        <div className="container mx-auto">
          ...
          <p className="text-lg max-w-3xl mx-auto text-center mb-12">
            Our latest articles, news, and industry insights. Stay updated with the latest trends and developments.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Blog Post Cards */}
            {Array(6).fill(0).map((_, index) => (
              <div key={index} className="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                <div className="bg-gray-200 h-48 flex items-center justify-center">
                  <span className="text-gray-500">Blog Image {index + 1}</span>
                </div>
                <div className="p-6">
                  <span className="text-sm text-gray-500">May {index + 1}, 2025</span>
                  <h3 className="font-semibold text-xl mt-2 mb-3">Blog Post Title {index + 1}</h3>
                  <p className="text-gray-600 mb-4">A brief excerpt from the blog post that gives readers an idea of what the article is about.</p>
                  <button className="text-[#9b87f5] hover:text-[#D6BCFA] font-medium">Read More</button>
                </div>
              </div>
            ))}
          </div>
